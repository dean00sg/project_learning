...
$sql = "
    UPDATE classroom
    SET classroom_type = ?, classroom_number_code = ?, classroom_level = ?, advisor_staff_id = ?, building = ?
    WHERE classroom_id = ?
";

$stmt = $conn->prepare($sql);
$stmt->bind_param("ssissi", $classroom_type, $classroom_number_code, $classroom_level, $advisor_staff_id, $building, $classroom_id);
